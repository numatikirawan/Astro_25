...
const subTopics = [
  { label: "Penjumlahan Bilangan Bulat", path: "" },
  { label: "Pengurangan Bilangan Bulat", path: "" },
  { label: "Perkalian Bilangan Bulat", path: "" },
  { label: "Pembagian Bilangan Bulat", path: "" },
  { label: "Operasi Hitung Campuran Bilangan Bulat", path: "" },
  { label: "KPK dan FPB", path: "" },
];
