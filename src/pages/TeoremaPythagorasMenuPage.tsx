...
const subTopics = [
  { label: "Pembuktian Teorema Pythagoras", path: "" },
  { label: "Menghitung Panjang Segitiga Siku-Siku", path: "" },
  { label: "Triple Pythagoras", path: "" },
  { label: "Pythagoras dan Jenis-Jenis Segitiga", path: "" },
  { label: "Perbandingan Sisi Segitiga Siku-Siku Sudut Khusus", path: "" },
  { label: "Penerapan Teorema Pythagoras pada Masalah Kontekstual", path: "" },
];
