...
const subTopics = [
  { label: "Pengantar Statistika dan Pengumpulan Data", path: "" },
  { label: "Penyajian Data", path: "" },
  { label: "Ukuran Pemusatan Data (Rata-rata dan Rata-rata Gabungan)", path: "" },
  { label: "Ukuran Pemusatan Data (Median dan Modus)", path: "" },
  { label: "Ukuran Letak Data (Kuartil)", path: "" },
  { label: "Ukuran Penyebaran Data (Jangkauan, Jangkauan Interkuartil, Simpangan Kuartil)", path: "" },
];
