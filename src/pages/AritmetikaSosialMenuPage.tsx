...
const subTopics = [
  { label: "Jual Beli, Untung dan Rugi", path: "" },
  { label: "Diskon", path: "" },
  { label: "Bruto, Netto dan Tara", path: "" },
  { label: "Bunga Tunggal", path: "" },
  { label: "Pajak Pertambahan Nilai (PPN)", path: "" },
  { label: "Pajak Penghasilan (PPh)", path: "" },
];
