...
const subTopics = [
  { label: "Pengertian dan Notasi Pangkat", path: "" },
  { label: "Sifat-Sifat Operasi Bilangan Berpangkat", path: "" },
  { label: "Pangkat Nol, Pangkat Negatif dan Pangkat Pecahan", path: "" },
  { label: "Bentuk Akar", path: "" },
  { label: "Notasi Ilmiah", path: "" },
];
