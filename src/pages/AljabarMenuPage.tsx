...
const subTopics = [
  { label: "Pengertian dan Unsur-Unsur Bentuk Aljabar", path: "" },
  { label: "Penjumlahan dan Pengurangan Bentuk Aljabar", path: "" },
  { label: "Perkalian Bentuk Aljabar", path: "" },
  { label: "Pembagian Bentuk Aljabar", path: "" },
  { label: "Pemangkatan Bentuk Aljabar", path: "" },
  { label: "Substitusi Bilangan pada Bentuk Aljabar", path: "" },
  { label: "Faktorisasi Bentuk Aljabar", path: "" },
  { label: "Operasi Pecahan Bentuk Aljabar", path: "" },
];
