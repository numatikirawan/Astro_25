...
const subTopics = [
  { label: "Hubungan 2 Garis", path: "" },
  { label: "Sudut Pelurus, Sudut Penyikut dan Sudut Bertolak Belakang", path: "" },
  { label: "Sifat Sudut Dua Garis Sejajar Jika Dipotong Garis Lain", path: "" },
  { label: "Jumlah Sudut pada Segi Banyak", path: "" },
];
